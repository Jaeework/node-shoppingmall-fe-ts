...
export const buttonVariants = {
  ...
  "purple-gradient": "bg-gradient-to-r from-[var(--y2k-purple)] to-[var(--y2k-purple-vivid)] cursor-pointer",
  "magenta-gradient": "bg-gradient-to-r from-[var(--y2k-magenta)] to-[var(--y2k-magenta-vivid)] cursor-pointer",
  "rainbow-gradient": "bg-gradient-to-r from-purple-400 via-pink-400 to-purple-600 cursor-pointer",
} as const;
